...
export SUITOR_HEADER=/global/cfs/cdirs/m2957/tianyi/superlu_dist-symatch
...
cmake .. \
  ...
  -DCMAKE_C_FLAGS="-O2 -std=c11 -DPRNTlevel=1 -DPROFlevel=0 -DDEBUGlevel=1 -DAdd_" \
  -DCMAKE_CXX_FLAGS="-O2" \
  ...
  -DTPL_BLAS_LIBRARIES=/opt/cray/pe/libsci/24.07.0/GNU/12.3/x86_64/lib/libsci_gnu_mp.so \
  -DTPL_LAPACK_LIBRARIES=/opt/cray/pe/libsci/24.07.0/GNU/12.3/x86_64/lib/libsci_gnu_mp.so \
  ...
  -DTPL_PARMETIS_LIBRARIES="/global/cfs/cdirs/m3894/lib/PrgEnv-gnu/parmetis-4.0.3/install/lib/libparmetis.a;/global/cfs/cdirs/m3894/lib/PrgEnv-gnu/parmetis-4.0.3/install/lib/libmetis.a" \
  -DCMAKE_VERBOSE_MAKEFILE:BOOL=ON \
  -DMPIEXEC_NUMPROC_FLAG=-n \
  -DMPIEXEC_EXECUTABLE=/usr/bin/srun \
  -DMPIEXEC_MAX_NUMPROCS=16 \
  -DTPL_ENABLE_SYMATCHLIB=ON \
  -DTPL_SYMATCH_INCLUDE_DIRS="${SUITOR_HEADER}/matching/symatch/inc;${SUITOR_HEADER}/matching/symatch/util;${SUITOR_HEADER}/matching/lib/matching" \
