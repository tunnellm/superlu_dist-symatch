...
#define CudaMemcpyUVA(dest, src, size)\
CudaCall(cudaMemcpy(dest, src, size, cudaMemcpyDefault))

#define CudaMemcpyAsyncUVA(dest, src, size, stream)\
CudaCall(cudaMemcpyAsync(dest, src, size, cudaMemcpyDefault, stream))
