...
*
*  =====================================================================
      SUBROUTINE dlasyf_mod( UPLO, N, NB, KB, A, LDA, THRESH, 
     $IPIV, W, LDW, INFO, NTINY, N2x2)
*
...
*     .. Scalar Arguments ..
      CHARACTER          UPLO
      INTEGER            INFO, KB, LDA, LDW,N,NB,NTINY,N2x2
*     ..
*     .. Array Arguments ..
      INTEGER            IPIV( * )
      DOUBLE PRECISION   A( LDA, * ), W( LDW, * )
...
*            PRINT *, 'absakk in dlasyf_1', absakk, thresh, ntiny
            if(w( K, KW )>0)then
               w( K, KW ) = thresh 
               a( K, KW ) = thresh 
            else
...
*
         ...
         if(absakk<thresh)then
*            PRINT *, 'absakk in dlasyf_2', absakk, thresh,ntiny
            if(w( k, k )>0)then
               w( k, k ) = thresh 
               a( k, k ) = thresh 
            else
