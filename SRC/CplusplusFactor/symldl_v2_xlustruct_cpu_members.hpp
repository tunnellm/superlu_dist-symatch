...
std::vector<Ftype *> symV2CpuPr1DiagBufs;
std::vector<int_t *> symV2CpuPr1ColumnBlockBufs;
...
size_t symV2CpuPr1DiagCapacity = 0;
size_t symV2CpuPr1ColumnBlockCapacity = 0;
...
double symV2CpuPr1BroadcastTime = 0.0;
double symV2CpuPr1ReconstructTime = 0.0;
...
uint64_t symV2CpuRoutePanels[4] = {0, 0, 0, 0};
uint64_t symV2CpuReleaseEventsLocal = 0;
uint64_t symV2CpuReleaseEventsPartner = 0;
uint64_t symV2CpuReleaseEventsFullPanel = 0;
uint64_t symV2CpuPr1IndexBytes = 0;
