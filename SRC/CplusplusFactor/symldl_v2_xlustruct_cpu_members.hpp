...
std::vector<unsigned char> symV2CpuPartnerSendRowActive;
std::vector<SymLDLV2CpuPackSegment> symV2CpuPartnerSegments;
std::vector<int_t> symV2CpuPartnerRowPermutations;
std::vector<std::vector<int_t> > symV2CpuPartnerAssembledIndex;
std::vector<std::vector<int_t> > symV2CpuPartnerAssembleMaps;
std::vector<size_t> symV2CpuPartnerPeerRangeOffsets;
std::vector<SymLDLV2CpuBlockRange> symV2CpuPartnerPeerRanges;
...
std::vector<unsigned char> symV2CpuRequestKinds;
...
std::vector<unsigned char> symV2CpuPartnerPeerAssembled;
std::vector<SymLDLV2CpuExchangeState> symV2CpuExchangeStates;
std::vector<SymLDLV2CpuWindowState> symV2CpuWindowStates;
...
std::vector<int> symV2CpuWindowDonePanelBcast;
std::vector<int> symV2CpuWindowDonePanelSolve;
std::vector<int> symV2CpuWindowChildrenLeft;
...
double symV2CpuWindowExchangeTime = 0.0;
double symV2CpuWindowAssemblyTime = 0.0;
double symV2CpuWindowLookaheadTime = 0.0;
double symV2CpuWindowLookaheadWaitTime = 0.0;
double symV2CpuWindowExcludeTime = 0.0;
double symV2CpuWindowExcludeWaitTime = 0.0;
double symV2CpuWindowNextIssueTime = 0.0;
double symV2CpuHybridAssemblyTime = 0.0;
double symV2CpuHybridReleaseTime = 0.0;
...
uint64_t symV2CpuRoutePanels[3] = {0, 0, 0};
uint64_t symV2CpuReleaseEventsLocal = 0;
uint64_t symV2CpuReleaseEventsPartner = 0;
uint64_t symV2CpuWindowPanels = 0;
uint64_t symV2CpuWindowIterations = 0;
uint64_t symV2CpuWindowRectangles = 0;
uint64_t symV2CpuWindowInlineRectangles = 0;
uint64_t symV2CpuWindowDeferredRectangles = 0;
uint64_t symV2CpuWindowRowBlocks = 0;
uint64_t symV2CpuWindowColumnBlocks = 0;
uint64_t symV2CpuWindowMaxWidth = 0;
uint64_t symV2CpuHybridRectangles = 0;
uint64_t symV2CpuHybridInlineRectangles = 0;
uint64_t symV2CpuHybridDeferredRectangles = 0;
uint64_t symV2CpuHybridPeerReleases = 0;
