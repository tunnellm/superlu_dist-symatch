...
// SYM_V2_PCFRAG_TASKFLOW_STATE_BEGIN
    ...
    struct SymV2PcFragTaskflowStats
    {
        ...
        long long graph_output_completion_bytes;
        ...
        SymV2PcFragTaskflowStats()
            : row_pieces_created(0), partner_pieces_created(0),
              ...
              graph_output_completion_bytes(0),
    ...
    void symV2PcFragTaskflowPrintProfile()
    {
        ...
        long long local_group[21] = {
            ...
            symV2PcFragTaskflowStats.grouped_single_fallbacks_by_mode[
            ...
            symV2PcFragTaskflowStats.grouped_output_conflict_fallbacks_by_mode[
                SYM_V2_PCFRAG_TASK_LOOKAHEAD_COL],
            symV2PcFragTaskflowStats.grouped_output_conflict_fallbacks_by_mode[
                SYM_V2_PCFRAG_TASK_LOOKAHEAD_ROW],
            symV2PcFragTaskflowStats.grouped_output_conflict_fallbacks_by_mode[
        ...
        long long local_graph[23] = {
            ...
            symV2PcFragTaskflowStats.graph_output_completion_bytes
        };
        long long global_graph[23] = {};
        ...
        if (grid3d != NULL)
        {
            ...
            MPI_Reduce(local_graph, global_graph, 23, MPI_LONG_LONG,
                       MPI_SUM, 0, grid3d->comm);
        ...
        std::printf(
            ...
            "output_conflict_fallbacks_full=%lld\n",
        ...
        std::printf(
            ...
            global_graph[21], global_graph[22]);
        std::printf(
...
#undef XLU_V2_DTOR_TRACE
    ...
    int_t dSymSchurCompUpdateTaskDualPieceGroupGPU(
        ...
        cublasHandle_t handle, cudaStream_t cuStream,
        Ftype *gemmBuff);
    int_t dSymSchurCompUpdateTaskDualPiecePairListGroupGPU(
        int_t pair_count,
        int_t *pair_rows,
        int_t *pair_cols,
        int_t k,
